...
import dev.patbeagan.b20.contextual.actions.Move.Result.EndOfRoomFailure
import dev.patbeagan.b20.contextual.actions.Move.Result.Failure
import dev.patbeagan.b20.contextual.actions.Move.Result.Point
import dev.patbeagan.b20.contextual.actions.Move.Result.RoomId
import com.pbeagan.contextual.actions.type.Action
import dev.patbeagan.b20.util.exhaustive
...
class Move private constructor(
    ...
    private fun changeRooms(
        ...
        self.locationInRoom = moveToEntranceOfRoom(
            direction,
            self.locationInRoom.x,
            currentRoom,
            self.locationInRoom.y
    ...
    sealed class Result {
        class Point(val data: CompressedPoint) : Result()
    ...
    companion object {
        ...
        private fun getNewSpace(
            ...
            x: Int,
            y: Int,
        ): CompressedPoint = when (direction) {
            NORTH -> x coord y + 1
            EAST -> x + 1 coord y
            SOUTH -> x coord y - 1
            WEST -> x - 1 coord y
